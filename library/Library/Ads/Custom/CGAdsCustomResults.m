...
@interface CGAdsCustomResults ()

@property (nonatomic, retain, readwrite) NSArray* ads; // CGAdsCustomAd

@end

@implementation CGAdsCustomResults
...
- (id) copyWithZone:(NSZone*) zone {
	CGAdsCustomResults* copy = [super copyWithZone:zone];
	if (copy) {
...
- (BOOL) isEqual:(id) other {
	...
	return [self isEqualToAdsCustomResults:other];
}
...
- (NSString*) description {
	return [NSString stringWithFormat:@"<CGAdsCustomResults ads=%@>", self.ads];
}
